    ...
    class CameraInputs {
        ...
        public void fromPhotonPipeLine(PhotonPipelineResult pipelineResult,
            ...
            for (int i = 0; i < currentTargetsCount && i < MAX_TARGET_PER_CAMERA; i++) {
                ...
                // this.bestCameraToTargets[i] =
                // pipelineResult.getTargets().get(i).getBestCameraToTarget();
            }
        ...
        public void fromLog(LogTable table, int cameraID) {
            ...
            final Transform3d[] bestCameraToTargetsLogged = table
                .get(cameraKey + "bestCameraToTargets", new Transform3d[MAX_TARGET_PER_CAMERA]);
            ...
            this.bestCameraToField =
                bestCameraToFieldTransform.equals(NULL_TRANSFORM) ? Optional.empty()
    ...
    class VisionInputs implements LoggableInputs {
        ...
        public void fromLog(LogTable table) {
            ...
            if (table.get("camerasAmount", 0) != camerasAmount)
                throw new IllegalStateException("cameras amount from log (" + loggedCamerasAmount
