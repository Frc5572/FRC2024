...
public class Swerve extends SubsystemBase {
    ...
    public void periodic() {
         ...
         * SmartDashboard.putNumber("Gyro roll", inputs.roll); for (SwerveModule mod : swerveMods) {
         * mod.periodic(); SmartDashboard.putNumber("Mod " + mod.moduleNumber + " CANcoder",
         * mod.getCANcoder().getDegrees()); SmartDashboard.putNumber("Mod " + mod.moduleNumber +
         * " Angle", mod.getPosition().angle.getDegrees()); SmartDashboard.putNumber("Mod " +
         * mod.moduleNumber + " Velocity", mod.getState().speedMetersPerSecond); }
         */
    }
